...
function toggleWarmup() {
  document.getElementById("warmup").classList.toggle("hidden");
}

// QUOTES (FIXED)
const quotes = [
  { text: "Dance for yourself.", author: "Mikhail Baryshnikov" },
  { text: "Be fearless.", author: "Misty Copeland" },
  { text: "Just do.", author: "George Balanchine" },
  { text: "Technique is what you fall back on.", author: "Rudolf Nureyev" }
];
